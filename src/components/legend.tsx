...
import type { GraphEdge, GraphNode, LegendProps } from '../lib/types';
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="space-y-1.5">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs">{memoryCount} memories</span>
                        </div>
                        <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs">{edges.length} connections</span>
                        </div>
                      </div>
                    </div>
                  )}

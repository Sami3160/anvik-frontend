import type { DocumentsWithMemoriesResponseSchema } from '../validation/api.ts';
import type { z } from 'zod';

export type DocumentsResponse = z.infer<typeof DocumentsWithMemoriesResponseSchema>;
